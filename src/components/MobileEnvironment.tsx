      ...
      <div className="flex-1 p-6 grid grid-cols-3 gap-y-8 gap-x-4 content-start z-0 filter drop-shadow-xl font-sans">
        {icons.map((icon) => (
          ...
          >
            ...
            >
              <ImageRenderer src={icon.src} size={42} />
            </div>
        ...
        {activeSheet && (
          <>
            ...
            <motion.div
              ...
              className="absolute inset-x-0 bottom-0 top-0 bg-[#ECE9D8] z-50 rounded-t-[8px] overflow-hidden flex flex-col shadow-[2px_4px_10px_rgba(0,0,0,0.5)] border-[#003C74] border-[3px] border-b-0"
            >
